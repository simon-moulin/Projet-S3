# -*- coding: utf-8 -*-
"""Nombre de Formes Ordinary.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/194Q2nsyeOEXvvIALr7qEHKGtDbvioxdX
"""
...
def isoleNbOrdinary(desc) :   
    desc = desc.replace(',', '').split(' ')

    if("over" in desc):
      return desc[desc.index("over")+1]
    else:
      return "aucun"
...
with open('drive/My Drive/blasons50_b64.txt') as f:
    for line in f:
        ...
        categorie = isoleNbOrdinary(description_line)
...
model.save("nombreFormesOrdinarySayian.h5")
